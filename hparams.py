...
class Hparams:
    parser = argparse.ArgumentParser(description="GCP")
    ...
    parser.add_argument("--ptrain_percent", dest="train_data_percent", action="store", default=1.0, type=float,
...
class Classi_Hparams:
    ...
    # training scheme
    parser.add_argument("--logdir", dest="save", action="store", required=True, help="log directory")
    parser.add_argument("--lr", dest="lr", action="store", default=1e-3, type=float, 
    			help="learning rate")
