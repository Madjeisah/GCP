...
def main(args):
	...
	for epoch in range(args.epochs):
		...
		print("Train Epoch Loss: {:.4f}".format(train_loss))
		logger.add_scalar("Train Loss", train_loss, epoch)
		train_losses.append(train_loss)

		val_loss = run(args, epoch, "val", val_loader, model, optimizer)
		print("Val Epoch Loss: {:.4f}".format(val_loss))
	...
	print("Train Loss at epoch {} (best model): {:.4f}".format(best_epoch, best_train_loss))
	print("Val Loss at epoch {} (best model): {:.4f}".format(best_epoch, best_val_loss))
